...
public class UnidadPersistencia {
    ...
    public boolean nuevoUsuario(Usuario user) {
        return UsuarioPersis.crear(user, emf);
    }
    public Usuario verUsuario(Usuario user){
        return UsuarioPersis.verUsuario(user, emf);
    }

    public boolean nuevoInstituto(Instituto inst) {
        return InstitutoPersis.crearInstituto(inst, emf);
    }
    ...
    public Boolean actualizarDocente(Docente docente){
        return DocentePersis.ActualizarDocente(emf,docente);
    }
